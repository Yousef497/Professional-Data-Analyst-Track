...
#B. Provide a dictionary with the count of Oscar wins for each director in 
# the winners list.
...
win_count_dict = {}
# Add your code here
for years, winner_list in winners.items():
...
### Q2:Provide a list with the name(s) of the director(s) with the most Oscar wins.
# First part as 1B
